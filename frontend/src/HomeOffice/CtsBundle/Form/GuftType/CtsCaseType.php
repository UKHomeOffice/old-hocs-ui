...
use HomeOffice\CtsBundle\Form\GuftType\CtsCaseDocumentType;
...
abstract class CtsCaseType extends AbstractType
{
     ...
     * @var array
     */
    protected static $validCaseTypesForOGD = [
        'NPQ',
        'LPQ',
        'OPQ',
        'IMCB',
     ...
     * @var array
     */
    protected $validateIfStatus = [];

    /**
     * @var array
     */
    protected $validateIfTask = [];
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $topicList = $this->ctsListHandler->getList('ctsTopicList');
        ...
        ->add('correspondenceType', 'text', [
            'data' => $displayCorrespondenceType,
            'label' => 'Case type',
            'disabled' => true
        ])
        ->add('markupTopic', 'choice', [
            'choices' => $topicList,
        ...
        if (isset($linkedCases)) {
            foreach ($linkedCases as $linkedCase) {
                $builder
                ->add('linkedCase_'.$linkedCase->getNodeId(), 'text', [
                    'label' => '',
